...
class plantleaf:
    ...
    def predictPlantImage(self, image_file):
        ...
        # load the model
        model = load_model(r'E:\final minor project 2\Tomato-Plant-Leaf-Disease-Detection-Project\Tomato-Plant-Leaf-Disease-Detection-Project\Tomato-Plant-Leaf-Disease-Detection-Project\GCP Deploy\model.h5')
